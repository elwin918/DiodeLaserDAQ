...
class SerialThread(threading.Thread):
    ...
    def start_recording(self, filename=None):
        ...
        if filename is None:
            ...
            ## I don't really know how it works super well but when you first run the program with no data points, it will prevent the GUI graph to work
            ...
            if not existance.is_file():
                with open(self.recordingfilename, 'w', newline='') as csvfile:
                    ...
                    filewriter.writerow(['Data/Time', ' Laser9', ' Laser10', ' Laser3', ' Laser4', ' Laser5', ' Laser6', ' Laser7', ' SMU', ' Vin (5)', ' Set Mon V', ' I Mon V', ' Temp(F)', ' Vin (28)'])
