...
class SerialThread(threading.Thread):
    ...
    def start_recording(self, filename=None):
        ...
        if filename is None:
            ...
            ## When you first run the program with no data points, it may prevent the GUI graph to work
            ...
            if not existance.is_file():
                with open(self.recordingfilename, 'w', newline='') as csvfile:
                    ...
                    filewriter.writerow([
                        'Data/Time',
                        ' Laser9: ' + str(globals.power_factors[8]),
                        ' Laser10: ' + str(globals.power_factors[9]),
                        ' Laser3: ' + str(globals.power_factors[2]),
                        ' Laser4: ' + str(globals.power_factors[3]),
                        ' Laser5: ' + str(globals.power_factors[4]),
                        ' Laser6: ' + str(globals.power_factors[5]),
                        ' Laser7: ' + str(globals.power_factors[6]),
                        ' Laser8: ' + str(globals.power_factors[7]),
                        ' float',
                        ' Battery ',
                        ' SetMon',
                        ' IMon',
