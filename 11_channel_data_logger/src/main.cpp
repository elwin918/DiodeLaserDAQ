...
void ADC_ISR(void) {
  ...
  sptr->avals[5] = (uint16_t)analogRead(ADCPins[5]);
  sptr->avals[6] = (uint16_t)analogRead(ADCPins[6]);
  sptr->avals[7] = (uint16_t)analogRead(ADCPins[7]);
  sptr->avals[8] = (uint16_t)analogRead(ADCPins[8]);
  sptr->avals[9] = (uint16_t)analogRead(ADCPins[9]);
  sptr->avals[10] = (uint16_t)analogRead(ADCPins[10]);
  samplecount++;
  bufferindex++;
}
